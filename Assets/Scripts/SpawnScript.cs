...
public class SpawnScript : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log(spawnScheme.wive.Length + " +++  " + spawnScheme.wive[0].mobs.Length);
        ...
        Debug.Log(shopersWithWave.Count + " +++  " + shopersWithWave[0].Count);
        startSpawn = false;
        waveTimer = 0;
    ...
    private void EnemySpawn()
    {
        ...
        {
            float spread = Random.RandomRange(-3.0f, 3.0f);
